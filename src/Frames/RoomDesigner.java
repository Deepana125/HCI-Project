...
//    private static final String DEFAULT_FILE_PATH = "design.txt";
    ...
    private void saveDesign() {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            String filePath = fileToSave.getAbsolutePath(); // Get the absolute path of the selected file
    ...
    private JPanel createTopToolbar() {
        ...
        topToolbar.add(new JTextField(10)); // Set appropriate size

        // Add Width and Height input fields and labels
        topToolbar.add(new JLabel("Width"));
        topToolbar.add(new JTextField(5)); // Set appropriate size
